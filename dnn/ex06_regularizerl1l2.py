...
model_l2.add(Dense(128, input_dim=200, kernel_regularizer=l1(0.01)))
model_l2.add(Activation('relu'))

# (Do!) 請加入 L2 regularizer
model_l2.add(Dense(256, kernel_regularizer=l1(0.01)))
model_l2.add(Activation('relu'))

# (Do!) 請加入 L2 regularizer
model_l2.add(Dense(5, kernel_regularizer=l1(0.01)))
